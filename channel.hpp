...
#define RPL_CHANNELMODEIS(nick, channel, modes) ":ircserv_KAI.chat 324 " + nick + " " + channel + " +" + modes + "\r\n"
#define RPL_CREATIONTIME(nick, channel, c_time) ":ircserv_KAI.chat 329 " + nick + " " + channel + " " + c_time + "\r\n"
